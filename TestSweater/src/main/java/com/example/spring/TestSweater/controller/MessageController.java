...
import com.example.spring.TestSweater.repos.MessageRepo;
import com.example.spring.TestSweater.service.MessageService;
...
//        Page<Message> page = messageRepo.findByAuthor(author, pageable);
        Page<MessageDto> page = messageService.messageListForUser(pageable, user);
