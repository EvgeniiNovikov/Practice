package com.example.spring.TestSweater;


import com.example.spring.TestSweater.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main").param("filter", "my-tag"))
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@id=3]").exists());
    }
    ...
    public void addMessageToList() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@id=10]").exists())
                .andExpect(xpath("//div[@id='message-list']/div[@id=10]/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div[@id=10]/div/i").string("#new one"));
    }
}
